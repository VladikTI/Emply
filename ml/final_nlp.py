...
#Единая функция обработки и результата программы(вывод процента схожести)- запусти ее - выдает процент, насколько подходит данная анкета
#ank1- анкета, которую мы сравниваем, ank2 - анкета, с которой мы сравниваем
import nest_asyncio
import math
nest_asyncio.apply()
...
#функция расчета процента прохода - скоррее всего надо ее на фронт
def client(email):
